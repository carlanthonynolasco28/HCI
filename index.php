   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td>₱<?php echo $sub_total = (floatval(preg_replace("/[^0-9.]/", "", $fetch_cart['price'])) * intval(preg_replace("/[^0-9]/", "", $fetch_cart['quantity']))); ?></td>
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Remove this item from the cart?');">remove</a></td>
         </tr>
      <?php
